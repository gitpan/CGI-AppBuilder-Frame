# This Makefile is for the CGI::AppBuilder::Frame extension to perl.
#
...
#     DISTNAME => q[CGI-AppBuilder-Frame-0.10.tar.gz]
#     NAME => q[CGI::AppBuilder::Frame]
#     PREREQ_PM => { Test::More=>q[0.45], Test::Harness=>q[0.1], CGI::AppBuilder=>q[0.11] }
#     VERSION => q[0.1]
#     test => { TESTS=>q[t/ab_Frame.t] }
...
AR_STATIC_ARGS = cr
DIRFILESEP = /
NAME = CGI::AppBuilder::Frame
NAME_SYM = CGI_AppBuilder_Frame
VERSION = 0.1
...
DISTNAME = CGI-AppBuilder-Frame-0.10.tar.gz
DISTVNAME = CGI-AppBuilder-Frame-0.10.tar.gz-0.1
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         CGI-AppBuilder-Frame-0.10.tar.gz' >> META.yml
